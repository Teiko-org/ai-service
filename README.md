...
│   ├── alerts.py        # Heuristicas de alertas + cache (V2)
...
│   ├── actions.py       # Acoes PATCH/POST com confirmacao (V2)
│   ├── deep_orders.py   # Filtros e detalhes via resumo-pedido (V2)
│   ├── batches.py       # Consultas de fornadas (V2)
│   └── catalog.py       # Cardapio / catalogo (V2)
└── models/
...
- `scripts/smoke_stack.py` — checagens rapidas contra backend e AI (ver `AGENTS.md` na raiz do servico)
